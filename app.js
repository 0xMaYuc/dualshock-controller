...
async function calibrate_range(controller, dependencies, doneCallback = null) {
  destroyCurrentInstance$2(); // Clean up any existing instance
 ...
 */
function quicktest_handle_controller_input(changes) {
